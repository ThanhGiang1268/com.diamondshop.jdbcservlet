...
<div class="header-nav">
	<div class="container">
		<div class="wrapper flexitem">
			<a href="#" class="trigger desktop-hide"><span
				class="i ri-menu-2-line"></span></a>
										...
										<c:forEach var="item" items="${ categories }">
											<div class="flexcol">
												<div class="row">
													<h4>${ item.name }</h4>
													<ul>
														<c:forEach var="ditmemay" items="${ products }">
															<li><a href="#">${ ditmemay.name }</a></li>
														</c:forEach>
											...
											<div class="row">
												<div class="media">
													<div class="thumbnail object-cover">
														<a href="#"> <img src="assets/products/apparel4.jpg"
															alt="">
														</a>
													</div>
												</div>
			...
			<div class="left">
				<div class="dpt-cat">
					<div class="dpt-head">
						...
						<a href="#" class="dpt-trigger mobile-hide"> <i
							class="ri-menu-3-line ri-xl"></i>
						</a>
					</div>
					<div class="dpt-menu">
						<ul class="second-links">
							<li class="has-child beauty"><a href="#">
									<div class="icon-large">
							...
							<li class="has-child electric"><a href="#">
									<div class="icon-large">
							...
							<li class="has-child fashion"><a href="#">
									<div class="icon-large">
							...
							<li><a href="#">
									...
									</div> Health & Household
							</a></li>
							<li class="has-child homekit"><a href="#">
									<div class="icon-large">
										<i class="ri-hone-8-line"></i>
									</div> Home & Kitchen
									<div class="icon-small">
										<i class="ri-arrow-right-s-line"></i>
									</div>
			...
			<div class="right">
				<div class="search-box">
					<form action="" class="search">
						<span class="icon-large"><i class="ri-search-line"></i></span> <input
							type="search" placeholder="Search fot products">
					</form>
				</div>
			</div>
		</div>
