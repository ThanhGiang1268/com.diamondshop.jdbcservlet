		...
		<div class="wrapper">
			<div class="box">
				<div class="content">
					...
					<p>
						Get E-mail updates about our latest shop and <strong>special
							offers</strong>
					</p>
				</div>
				<form action="" class="search">
					<span class="icon-large"><i class="ri-mail-line"></i></span> <input
						type="mail" placeholder="Your email address" required>
			...
			<div class="flexcol">
				...
				<div class="socials">
					<ul class="flexitem">
						...
						<li><a href="#"><i class="ri-linnkedin-line"></i></a></li>
